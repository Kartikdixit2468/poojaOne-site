...
import grihaPraveshImg from "../assets/griha-pravesh.png";
import satyanarayanPujaImg from "../assets/satyanarayan-puja.png";
import ganeshPujaImg from "../assets/ganesh-puja.png";
import mahaMrityunjayaHavanImg from "../assets/maha-mrityunjaya-havan.png";
import vivahSanskarImg from "../assets/vivah-sanskar-puja.png";
import navagrahaSanskar from "../assets/navagraha-shanti-puja.png";
import namkaranSanskar from "../assets/namkaran-sanskar-puja.png";
import kaalSarpDosh from "../assets/kaal-sarp-dosh-puja.png"
import mahaLakshmi from "../assets/maha-lakshmi-puja.png"
import rudrabhishek from "../assets/rudrabhishek.png"
...
const ALL_POOJAS = [
  {
    ...
    description:
      "Bring prosperity and happiness to your home with the divine blessings of Lord Vishnu.",
    price: "₹2,100",
  ...
  },
  {
    ...
    title: "Griha Pravesh",
    description:
      "Essential housewarming ceremony to purify your new home and invite positive energy.",
    price: "₹5,100",
  ...
  },
  {
    ...
    description:
      "Powerful fire ritual for health, longevity, and removing obstacles from life.",
    price: "₹3,500",
    icon: <Flame className="w-8 h-8 text-brand" />,
    image: mahaMrityunjayaHavanImg,
  },
  {
    id: "marriage",
    category: "Sanskar",
    title: "Vivah Sanskar",
    description:
      "Complete wedding rituals performed by experienced Vedic Acharyas.",
    price: "Consult",
    icon: <Heart className="w-8 h-8 text-brand" />,
    image: vivahSanskarImg,
  },
  {
    id: "ganesh",
    category: "Puja",
    title: "Ganesh Puja",
    description:
      "Remove all obstacles and start new ventures with the blessings of Lord Ganesha.",
    price: "₹1,500",
  ...
  },
  {
    ...
    description:
      "Pacify the nine planets and reduce their malefic effects on your life.",
    price: "₹4,100",
    image: navagrahaSanskar,
      // "https://images.unsplash.com/photo-1518803194621-27188ba362c9?w=400&h=300&fit=crop",
  },
  {
    id: "namkaran",
    category: "Sanskar",
  ...
  },
  {
    ...
    description:
      "Special ritual to nullify the effects of Kaal Sarp Dosh in your horoscope.",
    price: "₹3,100",
  ...
  },
  {
    ...
    description:
      "Invoking the Goddess of Wealth for financial stability and abundance.",
    price: "₹2,500",
  ...
  },
  {
    ...
    title: "Rudrabhishek",
    description:
      "Sacred bathing of Lord Shiva aimed at fulfilling all desires and attaining peace.",
    price: "₹3,100",
    icon: <Flame className="w-8 h-8 text-brand" />,
    image:rudrabhishek,
  },
...
const Home = () => {
  ...
  return (
    <div className="font-sans text-text bg-surface">
      ...
      <section
        id="services"
        className="py-20 bg-gradient-to-b from-section via-brand-soft/5 to-section relative overflow-hidden"
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-text-muted max-w-2xl mx-auto">
              Choose from a wide range of Vedic rituals performed by experienced
              Acharyas at your home, office, or factory.
            </p>
          </div>
          ...
          <div className="relative group/rail mb-12">
            ...
            <div
              ...
              className="flex overflow-x-auto gap-6 pb-4 pl-4 pr-4 md:pl-8 md:pr-8 lg:pl-16 lg:pr-16 snap-x snap-mandatory scrollbar-hide"
              style={{
                scrollbarWidth: "none",
                  ...
                  <div className="h-full group relative">
                    ...
                    >
                      ...
                      <div className="p-5 lg:p-6 flex flex-col flex-grow">
                        <h3 className="text-lg lg:text-xl font-bold mb-2 text-text group-hover:text-brand transition-all duration-300 group-hover:tracking-wide">
                          {service.title}
                        </h3>
                        ...
                        <div className="flex items-center justify-between mt-auto pt-4 border-t border-border group-hover:border-brand/30 transition-colors duration-300">
                          <span
                            className="text-brand font-bold text-lg inline-block transition-transform duration-300 ease-out"
                            style={{ transform: "scale(1)" }}
                            onMouseEnter={(e) =>
                              (e.currentTarget.style.transform = "scale(1.1)")
                            }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-text-muted">
                      Only experienced Vedic scholars
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-text-muted mb-8 leading-relaxed">
                We understand the sanctity of your rituals. That's why we ensure
                every Puja is performed with utmost devotion, purity, and
      ...
      <section
        id="process"
        className="py-20 bg-gradient-to-b from-footer via-footer to-[#1a1a1a] text-white"
      >
            ...
            {[
              {
                step: 1,
                title: "Select Puja",
                desc: "Choose the ritual you wish to perform.",
              },
              {
                step: 2,
                title: "Enter Details",
                desc: "Provide your location and preferred date.",
              },
              {
                step: 3,
                title: "Acharya Arrives",
                desc: "Acharya performs the puja at your place.",
              },
            ].map((item) => (
              <div
                key={item.step}
      ...
      <section
        id="reviews"
        className="py-20 bg-gradient-to-b from-section via-brand-soft/8 to-surface relative overflow-hidden"
      >
        {/* Decorative Elements */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-muted max-w-sm">
                Your trusted partner for all Vedic rituals and spiritual
                services. Connecting you with the divine, right at your home.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-muted">
                <li>
                  <a href="#home" className="hover:text-brand transition">
                    Home
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#process" className="hover:text-brand transition">
                    How it works
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted">
                ...
                <li className="flex items-center">
                  <MapPin size={16} className="mr-2" /> Bangalore, India
                </li>
                <li className="flex items-center">
                  <User size={16} className="mr-2" /> support@poojaone.in
                </li>
              </ul>
            </div>
          </div>
          <div className="pt-8 border-t border-text/10 text-center text-muted text-sm">
            © {new Date().getFullYear()} PoojaOne.in. All rights reserved. Shubh
            Labh.
          </div>
        </div>
      </footer>
